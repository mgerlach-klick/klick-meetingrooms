...
}catch (e12537){if((e12537 instanceof Error)){
var e = e12537;
...
weasel.repl.repl_print.cljs$lang$applyTo = (function (seq12538){
return weasel.repl.repl_print.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq12538));
});

weasel.repl.console_print = (function weasel$repl$console_print(var_args){
var args__8715__auto__ = [];
var len__8708__auto___12543 = arguments.length;
var i__8709__auto___12544 = (0);
while(true){
if((i__8709__auto___12544 < len__8708__auto___12543)){
args__8715__auto__.push((arguments[i__8709__auto___12544]));

var G__12545 = (i__8709__auto___12544 + (1));
i__8709__auto___12544 = G__12545;
continue;
} else {
}
break;
...
weasel.repl.console_print.cljs$lang$applyTo = (function (seq12542){
return weasel.repl.console_print.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq12542));
});
...
while (G__12547__i < G__12547__a.length) {G__12547__a[G__12547__i] = arguments[G__12547__i + 0]; ++G__12547__i;}
  args = new cljs.core.IndexedSeq(G__12547__a,0);
} 
...
var args__8715__auto__ = [];
var len__8708__auto___12556 = arguments.length;
var i__8709__auto___12557 = (0);
while(true){
if((i__8709__auto___12557 < len__8708__auto___12556)){
args__8715__auto__.push((arguments[i__8709__auto___12557]));

var G__12558 = (i__8709__auto___12557 + (1));
i__8709__auto___12557 = G__12558;
continue;
} else {
}
break;
...
weasel.repl.connect.cljs$core$IFn$_invoke$arity$variadic = (function (repl_server_url,p__12551){
var map__12552 = p__12551;
var map__12552__$1 = ((((!((map__12552 == null)))?((((map__12552.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__12552.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__12552):map__12552);
var verbose = cljs.core.get.call(null,map__12552__$1,new cljs.core.Keyword(null,"verbose","verbose",1694226060),true);
var on_open = cljs.core.get.call(null,map__12552__$1,new cljs.core.Keyword(null,"on-open","on-open",-1391088163));
var on_error = cljs.core.get.call(null,map__12552__$1,new cljs.core.Keyword(null,"on-error","on-error",1728533530));
var on_close = cljs.core.get.call(null,map__12552__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var print = cljs.core.get.call(null,map__12552__$1,new cljs.core.Keyword(null,"print","print",1299562414),new cljs.core.Keyword(null,"repl","repl",-35398667));
var repl_connection = weasel.impls.websocket.websocket_connection.call(null);
cljs.core.swap_BANG_.call(null,weasel.repl.ws_connection,cljs.core.constantly.call(null,repl_connection));

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (repl_connection,map__12552,map__12552__$1,verbose,on_open,on_error,on_close,print){
return (function (evt){
...
});})(repl_connection,map__12552,map__12552__$1,verbose,on_open,on_error,on_close,print))
);

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"message","message",-406056002),((function (repl_connection,map__12552,map__12552__$1,verbose,on_open,on_error,on_close,print){
return (function (evt){
var map__12554 = cljs.reader.read_string.call(null,evt.message);
...
var message = map__12554__$1;
var op = cljs.core.get.call(null,map__12554__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
var response = cljs.core.pr_str.call(null,weasel.repl.process_message.call(null,message));
return clojure.browser.net.transmit.call(null,repl_connection,response);
});})(repl_connection,map__12552,map__12552__$1,verbose,on_open,on_error,on_close,print))
);

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (repl_connection,map__12552,map__12552__$1,verbose,on_open,on_error,on_close,print){
return (function (evt){
...
clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"error","error",-978969032),((function (repl_connection,map__12552,map__12552__$1,verbose,on_open,on_error,on_close,print){
return (function (evt){
if(cljs.core.truth_(verbose)){
...
weasel.repl.connect.cljs$lang$applyTo = (function (seq12549){
var G__12550 = cljs.core.first.call(null,seq12549);
var seq12549__$1 = cljs.core.next.call(null,seq12549);
return weasel.repl.connect.cljs$core$IFn$_invoke$arity$variadic(G__12550,seq12549__$1);
});
